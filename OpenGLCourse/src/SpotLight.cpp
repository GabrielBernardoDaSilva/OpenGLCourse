...
SpotLight::SpotLight(GLuint shadowWidth, GLuint shadowHeight,
                     ...
                     GLfloat con, GLfloat lin, GLfloat exp, GLfloat edge) : PointLight(shadowWidth, shadowHeight, near, far, red, green, blue, aIntensity, dIntensity, xPos, yPos, zPos, con, lin, exp), edge(edge)
{
